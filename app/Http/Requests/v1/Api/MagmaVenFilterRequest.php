...
class MagmaVenFilterRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'start_date' => 'nullable|after_or_equal:2015-05-01|before:today',
            'end_date' => 'nullable|after_or_equal:start_date|before:today',
