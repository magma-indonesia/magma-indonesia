...
class DetailKegiatanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $this->validate($request, [
            ...
            'proposal' => 'nullable|file|mimetypes:application/msword|max:100000',
            'laporan_kegiatan' => 'nullable|file|mimetypes:application/msword|max:100000',
            ...
            'proposal.mimes' => 'Format Proposal yang didukung doc dan docx',
            'proposal.max' => 'Ukuran Proposal maksimal 32MB',
            'laporan_kegiatan.mimes' => 'Format Laporan yang didukung doc dan docx',
