...
class GerakanTanahController extends Controller
{
    ...
    protected function nonFilteredGertan($request)
    {
        ...
        $gertans = Cache::remember('v1/home/magma:sigertan:'.$page, 120, function() {
        ...
        $grouped = Cache::remember('v1/home/magma:sigertan:grouped'.$page, 120, function() use($gertans) {
    ...
    {
        $q == 'q' ? $this->nonFilteredGertan($request) 
