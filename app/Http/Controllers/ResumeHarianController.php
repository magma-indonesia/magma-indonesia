...
class ResumeHarianController extends Controller
{
    ...
    protected function getLatestVona($bencana)
    {
        ...
        $abu_vulkanik = $vona->vc_height ? 'Abu vulkanik teramati dengan ketinggian '.round($vona->vc_height/3.2).'  m di atas permukaan laut atau sekitar '.round($vona->vc_height/3.2)-round($vona->summit_elevation).' m di atas puncak.' : 'Erupsi tidak teramati.' ;
