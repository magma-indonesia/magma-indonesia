...
class CreateVarKlimatologisTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('var_klimatologis', function (Blueprint $table) {
            ...
            $table->decimal('curah_hujan',5,2)->default(0.0);
            $table->char('kecangin',32)->nullable();
            $table->char('arahangin',100)->nullable();
            $table->decimal('suhumin',4,2)->default(0.0);
            $table->decimal('suhumax',4,2)->default(0.0);
            $table->decimal('lembabmin',5,2)->default(0.0);
            $table->decimal('lembabmax',5,2)->default(0.0);
            $table->decimal('tekmin',5,2)->default(0.0);
            $table->decimal('tekmax',5,2)->default(0.0);
            $table->timestamps();
        });
    }
