...
class CreateSigertanVerifikatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sigertan_verifikators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sigertan_verifikators');
    }
}
