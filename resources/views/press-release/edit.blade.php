...
<div class="content content-boxed no-top-padding">
    <form action="{{ route('chambers.press-release.update', $pressRelease) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>Judul</label>
                                            <input type="text" value="{{ old('judul') ?: $pressRelease->judul }}" class="form-control"
                                                name="judul" placeholder="Judul dari Press Release" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input name="datetime" id="datepicker" class="form-control" type="text"
                                                value="{{ old('datetime') ?: $pressRelease->datetime }}">
                                            @if( $errors->has('datetime'))
                                            <label class="error" for="datetime">{{ ucfirst($errors->first('datetime'))
                                                }}</label>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" value="{{ old('no_surat') ?: $pressRelease->no_surat }}" class="form-control"
                                                name="no_surat" placeholder="No. Surat Press Release jika ada">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="form-group col-sm-12 lainnya" style="display: {{ $pressRelease->lainnya ? 'block' :'none'}};">
                                        ...
                                        <div class="form-group col-sm-12 gunung-api"
                                            style="display: {{ $pressRelease->gunung_api ? 'block' :'none'}};">
                                            <label>Gunung Api</label>
                                            <select id="code" class="form-control" name="code">
                                                @foreach($gadds as $gadd)
                                                <option value="{{ $gadd->code }}" {{ $pressRelease->code == $gadd->code ?
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <div>
                                                <p>Label digunakan untuk melakukan grouping jenis berita. Berguna untuk
                                                    dilakukan filtering. Jika label belum ada, bisa ditambahkan melalui
                                                    <a href="{{ route('chambers.tag.index') }}"
                                            ...
                                            <div class="form-group">
                                                <div class="table-responsive project-list">
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody>
                                                            @foreach ($pressReleaseFiles['files'] as $file)
                                                            <tr>
                        ...
                        <div class="tab-pane active">
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-left">
                                    ...
                                    <p>
                                        Gunakan judul yang jelas, tuliskan deskripsi dengan menggunakan bahasa Indonesia
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <textarea name="deskripsi"
                                                class="summernote">{{ old('deskripsi') ?: $pressRelease->deskripsi }}</textarea>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label class="checkbox" style="font-weight: normal"><input name="is_published" value="1" type="radio" class="i-checks is-published"
                                                            {{ $pressRelease->is_published ? 'checked' : ''}}> Ya, segera publikasikan </label>
                                                    <label class="checkbox" style="font-weight: normal"><input name="is_published" value="0" type="radio" class="i-checks is-published"
                                                            {{ $pressRelease->is_published ? '' : 'checked'}}> Tidak, simpan sebagai draft </label>
