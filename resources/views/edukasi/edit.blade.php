...
<div class="normalheader content-boxed">
	<div class="row">
        <div class="col-lg-12 m-t-md">
            ...
            <h1 class="m-b-md">
                <strong>Edit {{ $edukasi->judul }}</strong>
            </h1>
        ...
        <div class="col-lg-12">
            <div class="hpanel hred">
                <div class="panel-body">
                    <form action="{{ route('chambers.edukasi.update', $edukasi->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row m-b-lg">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label>Judul</label>
                                            <input type="text" value="{{ old('judul') ?: $edukasi->judul }}" class="form-control" name="judul" placeholder="Judul Informasi" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea name="deskripsi" class="summernote">{{ old('deskripsi') ?: $edukasi->deskripsi }}</textarea>
                                        </div>
                                    </div>
