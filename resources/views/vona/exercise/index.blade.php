        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <h2 class="font-light m-b-xs">
                    Daftar VONA Exercise Subscribers
                </h2>
                <small>Daftar VONA Exercise Subscribers yang pernah dibuat dan dikirim kepada stakeholder terkait.</small>
            </div>
        </div>
    </div>
@endsection
