...
<div class="small-header">
    <div class="hpanel">
        <div class="panel-body">
            ...
            <small>Menu ini digunakan untuk merubah laporan Press Release yang pernah dibuat</small>
        </div>
    </div>
</div>
@endsection
...
<div class="content animate-panel">
    <div class="row">
        <div class="col-lg-10">
            ...
            <form role="form" id="form" method="POST" action="{{ route('chambers.v1.press.update',$press->id) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="judul" type="text" class="form-control" value="{{ $press->judul }}" required>
                        </div>
                        <div class="form-group">
                            <label>Isi Press Release</label>
                            <textarea name="deskripsi" class="summernote">{!! htmlspecialchars_decode($press->deskripsi) !!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Upload Foto</label>
                            <img class="img-responsive m-b border-top border-bottom border-right border-left p-xs image-file" src="{{ $press->fotolink }}" style="max-width: 360px;">
                            <div class="m-b">
                                <label class="w-xs btn btn-outline btn-default btn-file">
                                    <i class="fa fa-upload"></i>
                                    <span class="label-file">Ganti Foto </span> 
                            ...
                            <label class="error"><small>Maximum 700KB, disarankan <b>Landscape</b></small></label>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        height = height > 480 ? height/3 : 360;
