                                        ...
                                        <div class="row p-md">
                                            <div class="form-group">
                                                ...
                                                <select id="gunungapi" class="form-control m-b" name="code">
                                                    ...
                                                    <option value="{{ $gadd->ga_code }}" {{ old('code') == $gadd->ga_code ? 'selected' : '' }}>{{ $gadd->ga_nama_gapi }}</option>      
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-daterange">
                                                    <input id="start" type="text" class="form-control" value="{{ empty(old('start')) ? now()->subDays(14)->format('Y-m-d') : old('start')}}" name="start">
