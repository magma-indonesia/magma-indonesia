            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-heading">
                        Form Buat Kegiatan Baru MGA
                    </div>

                    <div class="panel-body">
                        <form action="{{ route('chambers.administratif.mga.kegiatan.store') }}" method="post">
                            @csrf
                                            ...
                                            <div class="row p-md">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <select name="jenis_kegiatan" class="form-control">
                                                        ...
                                                        <option value="{{ $item->id }}">{{ '('.$item->bidang->code.') - '.$item->nama }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input name="year" id="date" class="form-control" value="{{ now()->format('Y') }}" type="text">
                                                </div>

                                                <div class="form-group col-sm-12">
                                                    <label>Target Jumlah Kegiatan</label>
                                                    <input type="number" value="0" class="form-control" name="target_jumlah" value="0" required min="0" max="100">
                                                </div>
