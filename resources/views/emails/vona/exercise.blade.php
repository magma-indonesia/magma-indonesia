                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table class="table">
                                                ...
                                                <tr style="background-color: rgba(0, 0, 0, 0.03);">
                                                    <td colspan="4">
                                                        <h3 style="margin-bottom: 10px"><b>{{ $vona->ga_nama_gapi.'
                                                                '.$vona->issued }}</b></h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b>:</b></td>
                                                    <td>{{ $vona->vc_height ? $vona->vc_height_text : 'Volcanic ash is
                                                        not visible/observed.' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>(13)</td>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td> <a href="http://htmlemail.io"
                                                                                target="_blank">{{ $vona->ga_nama_gapi.'
                                                                                '.$vona->issued }}</a> </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block">
                                    <span class="apple-link">Center for Volcanology and Geological Hazard Mitigation
                                        (CVGHM)</span>
                                    <br>
                                    Jl. Diponegoro no. 57, Bandung, Jawa Barat, Indonesia
                                    <br>
                            ...
                            <tr>
                                <td class="content-block powered-by">
                                    Powered by <a href="{{ route('home') }}">MAGMA Indonesia</a>.
                                </td>
                            </tr>
                        </table>
                    </div>
