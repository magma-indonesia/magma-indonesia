...
<div class="row row-sm row-timeline">
    <div class="col-lg-9">
        ...
        <div class="card pd-30">
            ...
            <div class="timeline-group pd-l-30 pd-r-30">
                ...
                <div class="timeline-item">
                    <div class="timeline-body">
                        ...
                        <p class="timeline-title">
                            ...
                            @if ($vona->type == 'EXERCISE')
                            <span class="badge badge-warning tx-white">Exercise</span>
                            @endif
                        </p>
                        ...
                        <p class="timeline-author">
                            ...
                            <a href="{{ route('v1.gunungapi.ven.show', $vona->old_ven_uuid) }}" class="badge badge-primary tx-white">VEN</a>
                            @endif
                        </p>
    ...
    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
        ...
        <div class="card mg-t-20">
            <div class="card-body">
                <h5 class="card-title tx-dark tx-medium mg-b-10">Archived</h5>
                <hr>
                <a href="{{ route('v1.vona.index') }}" type="button" class="">Old Vona</a>
            </div>
        </div>
    </div>
</div>
