    ...
    <div class="hpanel">
        <div class="panel-body">
            ...
            <h2 class="font-light m-b-xs">
                Edit data Pendahuluan untuk Bencana Geologi Harian 
            </h2>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    <form action="{{ route('chambers.bencana-geologi.update',$bencanaGeologi) }}" method="post">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="col-lg-8">
                                        <div class="row p-md">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <input name="urutan" class="form-control" value="{{ $bencanaGeologi->urutan }}" min="1" placeholder="Masukkan urutan pelaporan" type="number">
                                            </div>
