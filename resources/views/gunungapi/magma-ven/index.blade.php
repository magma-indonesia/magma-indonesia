        ...
        <div class="col-lg-6 col-xs-12">
            <div class="hpanel hred">
                <div class="panel-body">
                    ...
                    <div class="m-t-xl">
                        <h1>{{ $magmaVens->first()->gunungapi->name }}</h1>
                        <p>
                            Letusan terjadi pada <b>{{ $magmaVens->first()->datetime_utc->formatLocalized('%A, %d %B %Y, %T WIB')}}</b>
                        </p>
                        <h1>
                            <a href="{{ route('chambers.letusan.show' ,['id' => $magmaVens->first()->id ]) }}" class="btn btn-outline btn-info" type="button" target="_blank"><i class="fa fa-eye"></i> Lihat Informasi</a>
                        </h1>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table id="table-ven" class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach($magmaVens as $key => $ven)
                                <tr>
                                    <td>{{ $magmaVens->firstItem()+$key }}</td>
