        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        <div class="row p-md">
                            <div id="plume" style="min-width: 310px; min-height: 680px; margin: 0 auto"></div>
                        </div>
                    </div>
                </div>
                @endif
...
<script>
    $(document).ready(function () {
        @role('Super Admin')
        $('#json-renderer').jsonViewer(@json($plume), {collapsed: true});
        @endrole
        ...
        Highcharts.stockChart('plume', {
            ...
            title: {
                text: 'Gas Plume of {{ $station_name }} Range of period {{ $date }}',
            },
            xAxis: {
                type: 'datetime',
            },
